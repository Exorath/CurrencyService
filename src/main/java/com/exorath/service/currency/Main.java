...
import com.exorath.service.currency.service.MongoService;
...
public class Main {
    ...
    public Main() {
        this.service = new MongoService(MongoProvider.getEnvironmentMongoProvider(), TableNameProvider.getEnvironmentTableNameProvider("DB_NAME"));
